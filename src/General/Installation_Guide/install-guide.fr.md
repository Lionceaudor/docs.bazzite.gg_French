...
### Configuration requise pour l'installateur
...
!!! Remarque 
    ...
    Le dual boot avec d'**autres distributions Linux**, en particulier **Fedora non-atomic**, n'est pas officiellement pris en charge. Il est recommandé d'utiliser le menu de démarrage UEFI de votre carte mère ou de renoncer complètement au dual boot afin d'éviter tout problème inattendu. Si un problème survient, restaurez le chargeur d'amorçage de Bazzite à l'aide de l'**outil de restauration du BootLoader** disponible dans l'ISO Live.
